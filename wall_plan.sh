...
python plan.py model_name=2025-01-25/02-51-33 n_evals=10 planner=mpc_cem goal_H=5 goal_source='random_state' seed=1 
python plan.py model_name=2025-01-25/02-51-33 n_evals=10 planner=mpc_cem goal_H=5 goal_source='random_state' seed=2
python plan.py model_name=2025-01-25/02-51-33 n_evals=10 planner=mpc_cem goal_H=5 goal_source='random_state' seed=3 
python plan.py model_name=2025-01-25/02-51-33 n_evals=10 planner=mpc_cem goal_H=5 goal_source='random_state' seed=4
python plan.py model_name=2025-01-25/02-51-33 n_evals=10 planner=mpc_cem goal_H=5 goal_source='random_state' seed=5
