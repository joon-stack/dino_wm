...
#SBATCH --job-name=maze_cls                 # Submit a job named "example"
...
accelerate launch train.py --config-name train.yaml env=point_maze frameskip=5 num_hist=3 encoder=dino_cls training.save_every_x_epoch=5
