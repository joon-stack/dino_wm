...
accelerate launch --main_process_port 29504   train.py --config-name train.yaml env=deformable_env frameskip=1 num_hist=1 encoder=dinov1 training.save_every_x_epoch=10
