...
#SBATCH --job-name=wall_obj_dinov2                 # Submit a job named "example"
...
accelerate launch --main_process_port 29503 train.py --config-name train_object.yaml env=wall_object_dinov2_small frameskip=5 num_hist=1 encoder=dino training.save_every_x_epoch=10
