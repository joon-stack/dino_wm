...
#SBATCH --job-name=pusht                # Submit a job named "example"
...
accelerate launch --main_process_port 29505 train.py --config-name train.yaml env=pusht frameskip=5 num_hist=3 encoder=dinov1 training.save_every_x_epoch=1 training.epochs=5
