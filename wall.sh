...
#SBATCH --job-name=wall_dinov1_full                 # Submit a job named "example"
...
accelerate launch train.py --config-name train.yaml env=wall frameskip=5 num_hist=1 encoder=dinov1 training.save_every_x_epoch=10
